...
class Ui_ConfigWindow(object):
    def setupUi(self, ConfigWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 730, 377))
        ...
        self.input_hours_day_0 = QtWidgets.QDoubleSpinBox(parent=self.scrollAreaWidgetContents)
        self.input_hours_day_0.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.input_hours_day_1.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.input_hours_day_2.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.input_hours_day_3.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.input_hours_day_4.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.input_hours_day_5.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.input_hours_day_6.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_3, 7, 1, 1, 3)
        ...
        self.radio_weekday_0.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.radio_weekday_1.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.radio_weekday_2.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.radio_weekday_3.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.radio_weekday_4.setMaximumSize(QtCore.QSize(55, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.radio_weekday_5.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.radio_weekday_6.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_2, 6, 1, 1, 3)
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.input_different_times.setFont(font)
        self.input_different_times.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.gridLayout_2.addWidget(self.input_different_times, 5, 1, 1, 3)
        ...
        self.input_plot_pause.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.gridLayout_2.addWidget(self.input_plot_pause, 8, 1, 1, 3)
    ...
    def retranslateUi(self, ConfigWindow):
        ...
        self.label_5.setText(_translate("ConfigWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:700;\">Change your local settings.</span></p><p align=\"center\"><span style=\" font-size:10pt;\">Use decimals for minutes, e.g. 30 minutes are 30/60 = 0.5 h.</span></p></body></html>"))
        self.label_10.setText(_translate("ConfigWindow", "Different Times:"))
        self.label_9.setText(_translate("ConfigWindow", "Weekly Hours:"))
        self.label_6.setText(_translate("ConfigWindow", "Subdiv:"))
        self.label_11.setText(_translate("ConfigWindow", "Workdays:"))
        ...
        self.label_13.setText(_translate("ConfigWindow", "Time Per Day:"))
        self.label_12.setText(_translate("ConfigWindow", "Plot Pause:"))
