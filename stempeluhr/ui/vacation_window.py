...
class Ui_VacationWindow(object):
    def setupUi(self, VacationWindow):
        ...
        self.select_reason = QtWidgets.QComboBox(parent=VacationWindow)
        font = QtGui.QFont()
        font.setPointSize(18)
        self.select_reason.setFont(font)
        self.select_reason.setObjectName("select_reason")
        self.gridLayout.addWidget(self.select_reason, 1, 0, 1, 1)
        ...
        self.year_select.setMaximumSize(QtCore.QSize(100, 16777215))
        font = QtGui.QFont()
        font.setPointSize(18)
        ...
        self.gridLayout.addWidget(self.year_select, 0, 1, 1, 1)
    ...
    def retranslateUi(self, VacationWindow):
        ...
        self.label_list_view.setText(_translate("VacationWindow", "List of time off days in year x"))
