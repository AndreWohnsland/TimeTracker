...
class Ui_DataWindow(object):
    def setupUi(self, DataWindow):
        ...
        self.label_overtime = QtWidgets.QLabel(parent=DataWindow)
        self.label_overtime.setMaximumSize(QtCore.QSize(600, 16777215))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.label_overtime.setFont(font)
        self.label_overtime.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.project_selector = QtWidgets.QComboBox(parent=DataWindow)
        self.project_selector.setMinimumSize(QtCore.QSize(150, 40))
        self.project_selector.setMaximumSize(QtCore.QSize(300, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.project_selector.setFont(font)
        self.project_selector.setObjectName("project_selector")
        self.horizontalLayout.addWidget(self.project_selector)
    ...
    def retranslateUi(self, DataWindow):
        ...
        self.label_overtime.setText(_translate("DataWindow", "Overtime: +/- X hours"))
